...
<div class="max-w-7xl bg-white rounded-xl border-2 border-emerald-200 dark:border-gray-600 border-solid shadow-lg h-24 m-auto mt-10 flex justify-between px-8 items-center gap-10 dark:bg-gray-800">
