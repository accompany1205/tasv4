...
<div class="{_class}">
	...
	<div class="font-akshar">
		<div class="flex items-center">
			<span class="pt-[0.25rem] text-2xl">{rating.toFixed(1)}</span>
			<Rating
				class="ml-1 h-10 w-32"
				id="google-rating"
				total="{5}"
				size="{50}"
				rating="{rating}"
	...
	<div class="pt-[0.25rem] text-center font-akshar text-gray-600">
		<a
			class="hover:text-nile-blue-300"
			href="https://www.tutorsandservices.com/reviews/"
			target="_blank"
			rel="noopener noreferrer"
		>
			{ratingCount} Reviews
