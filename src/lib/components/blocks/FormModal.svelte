<script lang="ts">
    import { DropdownDivider, Modal, Button, Card, Label, Textarea, Input } from 'flowbite-svelte';
...
async function handleSubmit(event: any) {
    const JOTFORM_API = import.meta.env.VITE_JOTFORM_API;
    ...
    const url = `https://api.jotform.com/form/213494772938167/submissions?apiKey=${JOTFORM_API}`;
