<div class="overflow-x-hidden py-4">
	<h3 class="border-b-4 border-emerald-400 py-4 pl-4 text-3xl font-black max-w-screen-xl m-auto">Types of Service</h3>
	<div class="m-2 mx-auto flex max-w-screen-xl flex-wrap gap-4 text-white">
		<div class="card mx-auto w-full max-w-xs flex-shrink-0 bg-nile-blue-900 p-4">
			...
			<svg
				...
				aria-hidden="true"
				class="e-font-icon-svg e-fas-hands-helping"
				viewBox="0 0 640 512"
			...
			<p class="mt-4 text-center">
				Customized 1-on-1 tutoring sessions. Don't waste time & money in class. Learn only
		...
		<div class="card mx-auto w-full max-w-xs flex-shrink-0 bg-nile-blue-900 p-4">
			...
			<p class="mt-4 text-center">
				Share screens with us to cut costs and learn along the way. More communication
		...
		<div class="card mx-auto w-full max-w-xs flex-shrink-0 bg-nile-blue-900 p-4">
			...
			<svg
				style="fill: white; width: 50px; height: 50px; margin: auto;"
				aria-hidden="true"
				class="e-font-icon-svg e-fas-pencil-ruler"
				viewBox="0 0 512 512"
				xmlns="http://www.w3.org/2000/svg"
				><path
