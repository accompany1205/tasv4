<div class="py-4">
    ...
    <div class="flex  flex-wrap gap-4 m-2 text-white">
        <div class="card flex-shrink-0 bg-nile-blue-900 p-4 max-w-xs m-auto min-h-[12rem]">
            ...
            <p class="mt-4 text-center">
                Customized 1-on-1 tutoring sessions.
                Don't waste time & money in class.
        ...
        <div class="card flex-shrink-0 bg-nile-blue-900 p-4 max-w-xs m-auto min-h-[12rem]">
            ...
            <p class="mt-4 text-center">
                Share screens with us to cut costs and learn along the way.
