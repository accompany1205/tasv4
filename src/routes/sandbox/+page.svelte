<script>
	import Navigation from '$lib/components/sandbox/Navigation.svelte';
	import MainHero from '$lib/components/sandbox/MainHero.svelte';
	import {
		ArticleAuthor,
		ArticleBody,
		ArticleHead,
...
<Section name="feature">
	...
	>
		...
		<svelte:fragment slot="paragraph"
			...
			unlock long-term value and drive economic growth.</svelte:fragment
		>
	</HeroHeader>
	<FeatureDefault>
		<FeatureItem>
			...
			<svelte:fragment slot="paragraph"
				>Plan it, create it, launch it. Collaborate seamlessly with all the organization and
				hit your marketing goals every month with our marketing plan.</svelte:fragment
			>
		</FeatureItem>
		<FeatureItem>
			<svelte:fragment slot="icon"
			...
			<svelte:fragment slot="paragraph"
				>Protect your organization, devices and stay compliant with our structured workflows
				and custom permissions made for you.</svelte:fragment
			>
		</FeatureItem>
		<FeatureItem>
			<svelte:fragment slot="icon"
			...
			<svelte:fragment slot="paragraph"
				...
				of new templates to help you get started.</svelte:fragment
			>
		</FeatureItem>
		<FeatureItem>
			<svelte:fragment slot="icon"
			...
			<svelte:fragment slot="paragraph"
				...
				and quarterly budgeting.</svelte:fragment
			>
		</FeatureItem>
		<FeatureItem>
			<svelte:fragment slot="icon"
		...
		<FeatureItem>
			...
			<svelte:fragment slot="paragraph"
				...
				workflows built for all efficient teams and individual.</svelte:fragment
			>
		</FeatureItem>
	</FeatureDefault>
</Section>
